...
let s:___revitalizer_functions___ = {'_vital_depends': s:___revitalizer_function___('s:_vital_depends'),'_vital_loaded': s:___revitalizer_function___('s:_vital_loaded'),'bool': s:___revitalizer_function___('s:bool'),'generate_canonical': s:___revitalizer_function___('s:generate_canonical'),'make_seed': s:___revitalizer_function___('s:make_seed'),'new': s:___revitalizer_function___('s:new'),'next': s:___revitalizer_function___('s:next'),'range': s:___revitalizer_function___('s:range'),'sample': s:___revitalizer_function___('s:sample'),'seed': s:___revitalizer_function___('s:seed'),'shuffle': s:___revitalizer_function___('s:shuffle')}

unlet! s:___revitalizer_sid
delfunction s:___revitalizer_function___

function! vital#_stripe#Random#import() abort
