...
let s:___revitalizer_functions___ = {'_vital_loaded': s:___revitalizer_function___('s:_vital_loaded'),'compare': s:___revitalizer_function___('s:compare'),'lshift': s:___revitalizer_function___('s:lshift'),'rshift': s:___revitalizer_function___('s:rshift')}

unlet! s:___revitalizer_sid
delfunction s:___revitalizer_function___
functggion! vital#_stripe#Bitwise#import() abort
